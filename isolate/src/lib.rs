...
impl Plugin for CCIsolate {
    const NAME: &'static str = "MIDCIRCUIT CC Isolate";
...
impl Vst3Plugin for CCIsolate {
    const VST3_CLASS_ID: [u8; 16] = *b"MIDCRTCCIsolator";
    const VST3_SUBCATEGORIES: &'static [Vst3SubCategory] =
        &[Vst3SubCategory::Fx, Vst3SubCategory::Tools];
}

// nih_export_clap!(CCIsolate);
nih_export_vst3!(CCIsolate);
